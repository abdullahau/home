...
date = 2026-01-01
description = "Shows as a byline under the title, and as project-desc on the homepage/list when not hidden"
hidden = true
...
Hidden reference page for the `projects` front matter and templates
(`project-section.html` / `project-page.html` — the "updated" date instead
of a post date, via `_project-updated.html`). See
